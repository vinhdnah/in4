...
class ThanhDieuHeader implements ThanhDieuConfigInterface {
    ...
    public $avatar = "./res/v5/img/male.jpg";
    ...
    public $SocialNetworks = [
        "facebook" => "https://facebook.com/whenicoe1", // Thay link facebook
        "instagram" => "https://www.instagram.com/whenicoe1", // Thay link instagram
        "tiktok" => "https://www.tiktok.com/@v_study436", // Thay link tiktok
...
class ThanhDieuLoveDays implements ThanhDieuConfigInterface {
    public $ConfigLove = [
        ...
        "name_female" => "Maths", // Thay tên đối phương
        //========================================================//
        "time_relashiption" => "03/06/2008" // Định dạng ngày tháng năm: DD-MM-YYYY or / or :
        //========================================================//
    ];
    public function CommonMethod() {}
}
...
[
        ...
        [
            ...
            "avatar" => "https://i.ibb.co/q3XRz51B/that-girl.jpg",
            "title" => "That Girl",
            "author" => "Olly Murs"
        ],
        [
